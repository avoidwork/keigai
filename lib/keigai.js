/**
 * Lightweight data store library
 *
...
function xhr () {
	...
	headers = {
		"user-agent"   : "keigai/0.2.8 node.js/" + process.versions.node.replace( /^v/, "" ) + " (" + string.capitalize( process.platform ) + " V8/" + process.versions.v8 + " )",
