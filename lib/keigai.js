			...
			_prototypeProperties(KXMLHttpRequest, null, {
				...
				then: {
					value: function then(success, failure) {
						return this.defer.then(success, failure);
					},
					writable: true,
					configurable: true
				}
