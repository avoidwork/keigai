...
(function (global) {
   ...
   */
    ...
    */
			banner: function banner() {
				console.log([" __          .__             .__   ____     ________      ____ ________ ", "|  | __ ____ |__| _________  |__| /_   |    \\_____  \\    /_   /   __   \\", "|  |/ // __ \\|  |/ ___\\__  \\ |  |  |   |      _(__  <     |   \\____    /", "|    <\\  ___/|  / /_/  > __ \\|  |  |   |     /       \\    |   |  /    / ", "|__|_ \\\\___  >__\\___  (____  /__|  |___| /\\ /______  / /\\ |___| /____/  ", "     \\/    \\/  /_____/     \\/            \\/        \\/  \\/               "].join("\n"));
			},
   ...
   */
		var xhr = function xhr() {
			...
			var headers = {
				"user-agent": "keigai/1.3.19 node.js/" + process.versions.node.replace(/^v/, "") + " (" + string.capitalize(process.platform) + " V8/" + process.versions.v8 + " )",
