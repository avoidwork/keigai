...
/*
 __          .__             .__   ____     ________     ________ 
|  | __ ____ |__| _________  |__| /_   |    \_____  \   /   __   \
|  |/ // __ \|  |/ ___\__  \ |  |  |   |      _(__  <   \____    /
|    <\  ___/|  / /_/  > __ \|  |  |   |     /       \     /    / 
|__|_ \\___  >__\___  (____  /__|  |___| /\ /______  / /\ /____/  
     \/    \/  /_____/     \/            \/        \/  \/         
...
(function (global) {
   ...
   */
    ...
    *     filter = keigai.filter( document.querySelector( "input.filter" ), list, "field" );
    */
			factory: function factory(target, list, filters) {
   ...
   */
    ...
    * } );
    */
			factory: function factory(target, store, fields, sortable, options, filtered, debounce) {
				var ref = [store];
							...
							if (this.patch) {
								if (type === "del") {
									array.each(data, function (i) {
										patch.push(_this18.del(i, false, true));
									});
								} else {
									array.each(data, function (i) {
										patch.push(_this18.set(i[_this18.key] || null, i, true, false, true));
									});
								}
				...
				value: function select(where) {
					...
					if (!(where instanceof Object)) {
						...
						if (webWorker) {
							...
							sorted = array.flat(clauses.map(function (i) {
								return i.toString();
   ...
   */
    ...
    */
			banner: function banner() {
				console.log([" __          .__             .__   ____     ________     ________ ", "|  | __ ____ |__| _________  |__| /_   |    \\_____  \\   /   __   \\", "|  |/ // __ \\|  |/ ___\\__  \\ |  |  |   |      _(__  <   \\____    /", "|    <\\  ___/|  / /_/  > __ \\|  |  |   |     /       \\     /    / ", "|__|_ \\\\___  >__\\___  (____  /__|  |___| /\\ /______  / /\\ /____/  ", "     \\/    \\/  /_____/     \\/            \\/        \\/  \\/         "].join("\n"));
			},
   ...
   */
		var xhr = function xhr() {
			...
			var headers = {
				"user-agent": "keigai/1.3.9 node.js/" + process.versions.node.replace(/^v/, "") + " (" + string.capitalize(process.platform) + " V8/" + process.versions.v8 + " )",
