...
(function (global) {
   ...
   */
		var KXMLHttpRequest = (function (Base) {
			...
			_prototypeProperties(KXMLHttpRequest, null, {
				always: {
   ...
   */
		var xhr = function () {
			...
			var headers = {
				"user-agent": "keigai/1.2.0 node.js/" + process.versions.node.replace(/^v/, "") + " (" + string.capitalize(process.platform) + " V8/" + process.versions.v8 + " )",
