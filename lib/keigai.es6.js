...
let utility = {
	 ...
	 */
	banner: function () {
		console.log( [" __          .__             .__   ____     ________      ____  ________","|  | __ ____ |__| _________  |__| /_   |    \\_____  \\    /_   |/  _____/","|  |/ // __ \\|  |/ ___\\__  \\ |  |  |   |      _(__  <     |   /   __  \\ ","|    <\\  ___/|  / /_/  > __ \\|  |  |   |     /       \\    |   \\  |__\\  \\","|__|_ \\\\___  >__\\___  (____  /__|  |___| /\\ /______  / /\\ |___|\\_____  /","     \\/    \\/  /_____/     \\/            \\/        \\/  \\/            \\/ "].join( "\n" ) );
	},
...
let xhr = function () {
	...
	let headers = {
		"user-agent": "keigai/1.3.16 node.js/" + process.versions.node.replace( /^v/, "" ) + " (" + string.capitalize( process.platform ) + " V8/" + process.versions.v8 + " )",
